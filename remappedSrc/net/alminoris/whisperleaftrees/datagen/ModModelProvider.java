    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator)
    {
        ...
        for(String name : WOOD_NAMES)
        {
            ...
            registerLogBlock(blockStateModelGenerator, LOGS.get(name),
                    Identifier.of(net.alminoris.whisperleaftrees.WhisperleafTrees.MOD_ID, "block/"+name+"_log_top"),
                    Identifier.of(net.alminoris.whisperleaftrees.WhisperleafTrees.MOD_ID, "block/"+name+"_log"));

            registerLogBlock(blockStateModelGenerator, STRIPPED_LOGS.get(name),
                    Identifier.of(net.alminoris.whisperleaftrees.WhisperleafTrees.MOD_ID, "block/stripped_"+name+"_log_top"),
                    Identifier.of(net.alminoris.whisperleaftrees.WhisperleafTrees.MOD_ID, "block/stripped_"+name+"_log"));
